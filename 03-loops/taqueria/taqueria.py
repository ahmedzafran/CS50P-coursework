...
In a file called taqueria.py, implement a program that
...
"""
# while true promp user input + price addition loop + updated print statement if eof exception then exit

def main():
    y = 0.00
    while True:
        try:
            s = input("please enter your order: ")
            s = s.lower()
            s = s.capitalize()
            z = " "
            prmpt_flg = False
