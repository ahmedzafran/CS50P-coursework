...
In a file called numb3rs.py, implement a function called validate that expects an IPv4 address
 as input as a str and then returns True or False, respectively, if that input is a valid IPv4 address or not.
...
def validate(ip):
    valid_ip = r"""
    ^([2][5][0-5]|[2][0-4][0-9]|[1][0-9][0-9]|[0-9][0-9]|[0-9])\. # first octet of valid ip
    ([2][5][0-5]|[2][0-4][0-9]|[1][0-9][0-9]|[0-9][0-9]|[0-9])\.
    ([2][5][0-5]|[2][0-4][0-9]|[1][0-9][0-9]|[0-9][0-9]|[0-9])\.
    ([2][5][0-5]|[2][0-4][0-9]|[1][0-9][0-9]|[0-9][0-9]|[0-9])$
    """
    if re.search(valid_ip,ip,re.VERBOSE):
        return True
    else:
        return False
